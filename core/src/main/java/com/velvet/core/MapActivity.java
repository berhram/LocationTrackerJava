...
import com.velvet.core.ui.login.LoginContract;
import com.velvet.core.ui.passwordrecovery.PasswordRecoveryContract;

public class MapActivity extends AppCompatActivity implements LoginContract.Host, PasswordRecoveryContract.Host, SettingsContract.Host, MapContract.Host {
